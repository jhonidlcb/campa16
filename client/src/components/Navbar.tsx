      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className={`flex flex-col ${isScrolled ? "text-slate-900" : "text-white"} transition-colors`}>
              <span className="text-xl font-black leading-none tracking-tighter uppercase">{homeContent?.allianceName || "Alianza"}</span>
